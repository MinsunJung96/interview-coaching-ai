...
면접 진행 원칙:
${interviewTime <= -10 ? '1. [최종] 면접이 완료되었습니다. 더 이상 질문하지 마세요.' :
interviewTime <= 0 ? '1. [필수] 면접 마무리 멘트를 하세요. "네, 오늘 면접은 여기까지입니다. 수고하셨습니다." 같은 인사와 함께 긍정적인 피드백을 포함하세요.' : 
...
답변은 반드시 ${transitionMessage ? '2-3문장' : '1-2문장'}으로 짧게 하세요.`
      ...
      if (interviewTime <= 0 && hasClosingPhrase) {
        ...
        // 2초 후 자동으로 Step 5로 이동
        setTimeout(() => {
          console.log('면접 종료 - Step 5로 이동');
